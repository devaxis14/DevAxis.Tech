...
const SOCIAL_LINKS = [
  {
    label: "Facebook",
    href: "https://www.facebook.com/devaxis",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/devaxis",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/devaxis",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    label: "Twitter / X",
    href: "https://twitter.com/devaxis",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-4">
              Crafting exceptional digital experiences for businesses in Kochi,
              Kerala and beyond since 2019.
            </p>

            {/* NAP — Name, Address, Phone (must match Google Business Profile) */}
            <address className="not-italic text-sm space-y-1">
              <p className="text-white font-medium">DevAxis</p>
              <p>2nd Floor, Skyline Tower,</p>
              <p>Marine Drive, Kochi,</p>
              <p>Kerala 682031, India</p>
              <p className="mt-2">
                <a
